...
function MarketInfo({ liquidity, volume24h, underlyingAPY, impliedAPY }: MarketInfoProps) {
  return (
    <div className="grid grid-cols-4 gap-4 mb-6 bg-gray-800/50 rounded-lg p-4">
